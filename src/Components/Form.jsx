...
export default function Form() {
  ...
  return (
    <>
      <form onSubmit={handleSubmit} style={{display: 'flex', flexDirection:"column", textAlign: 'left', width:"400px", margin:"auto",gap:"0.5rem", border: '1px solid black',padding: '1rem', borderRadius: '10px'}}>
